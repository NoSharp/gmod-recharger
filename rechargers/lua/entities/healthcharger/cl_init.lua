...
function ENT:Draw()
	...
	--Holy Shit messy code alert! NEE NOOR
		...
		draw.RoundedBox(0, -90.5, -110, 180, 140, Color(150,0,0,220))
		draw.RoundedBox(0, -90.5, -150, 180, 40, Color(150,0,0,111))
		
		draw.SimpleText( "Health Charger","Trebuchet24", 0-60, -50-90, Color( 255, 255, 255, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
		...
		draw.RoundedBox(0, -90, 30, (self:GetAmount() * 1.8)/self:GetUpgradeLevel(),12, Color(255,50,50,255))
